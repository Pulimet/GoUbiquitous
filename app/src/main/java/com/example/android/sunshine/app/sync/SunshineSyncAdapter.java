...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    private void notifyWear(int weatherId, int high, int low) {
        ...
        String weatherIdKey = context.getString(R.string.wear_temp_weather_id);
        String weatherMinKey = context.getString(R.string.wear_temp_temp_min);
        String weatherMaxKey = context.getString(R.string.wear_temp_temp_max);
        int tempWeatherId = prefs.getInt(weatherIdKey, 0);
        int tempWeatherMin = prefs.getInt(weatherMinKey, 0);
